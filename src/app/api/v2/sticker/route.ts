  ...
  const output = await replicate.run(
    "zsxkib/instant-id:6af8583c541261472e92155d87bba80d5ad98461665802f2ba196ac099aaedc9",
    {
      input: {
        ...
        width: 512,
        height: 512,
        prompt: `Die-cut ${prompt === "Man" ? "male" : "female"} sticker, Cute kawaii ${prompt === "Man" ? "male" : "female"} character sticker, white background, illustration minimalism, vector, pastel colors`,
